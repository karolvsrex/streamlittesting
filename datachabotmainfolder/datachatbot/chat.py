...
def create_setup(view_model: ChatViewModel):
    ...
    uploaded_files = st.file_uploader("Please upload your PDF files", type=["pdf", "docx"], accept_multiple_files=True)
        ...
        with st.spinner('Moving your files into docs folder'):
            for uploaded_file in uploaded_files:
                ...
                if uploaded_file.type == "application/pdf":
                    ...
                    # TODO: Process or save the extracted text
                elif uploaded_file.type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document":
                    # TODO: Handle DOCX files (if needed)
                    pass
                else:
                    # TODO: Handle other file types or show an error message
                    pass
